...
%>
<FORM Action="8-25.jsp" Method="GET">
<% 
   if(Page != 1) {
      out.print("   <A HREF=8-25.jsp?Page=1>第一页</A>");
      out.print("   <A HREF=8-25.jsp?Page=" + (Page-1) + ">上一页</A>");
   }
   if(Page != totalPage) {
      out.print("   <A HREF=8-25.jsp?Page=" + (Page+1) + ">下一页</A>");
      out.print("   <A HREF=8-25.jsp?Page=" + totalPage + ">最后一页</A>");
   }
%>
